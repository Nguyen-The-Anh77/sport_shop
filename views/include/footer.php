					...
					<div class="container">
						<div class="row">
									...
									<div class="footer-text">
										<ul>
											<li>
												...
												<p> số 325, đường Lam Sơn, phường Đồng Tâm, tỉnh Vĩnh Phúc</p>
											</li>
											<li>
							...
							<div class="col-xs-12 col-sm-3 col-md-2 wide-mobile">
								<div class="single-text">
									...
									<div class="footer-menu">
										<ul>
											<li><a href="#"><i class="mdi mdi-menu-right"></i>New Products</a></li>
							...
							<div class="col-xs-12 col-sm-6 col-md-2 r-margin-top wide-mobile">
								<div class="single-text">
									...
									<div class="footer-menu">
										<ul>
											<li><a href="contact.php"><i class="mdi mdi-menu-right"></i>Return Exchange</a></li>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12" align="center">
								<p>&copy; Sportshop 2020. University of Transport Technology.</p>
							</div>
						</div>
					</div>
				</div>
