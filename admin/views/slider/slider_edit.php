    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="?mod=slider&act=update" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="title">Tiêu đề</label>
                                    <input type="text" class="form-control" id="title" name="title" value="<?php echo $slider['title']; ?>" placeholder="Nhập tiêu đề slider">
                                </div>

                                <div class="form-group">
                                    <label for="description">Mô tả</label>
                                    <textarea class="form-control" id="description" name="description" rows="3" placeholder="Nhập mô tả ngắn"><?php echo $slider['description']; ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="link">Link</label>
                                    <input type="text" class="form-control" id="link" name="link" value="<?php echo $slider['link']; ?>" placeholder="Link khi click vào slider">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php if($slider['image']): ?>
                                        <img src="../<?php echo $slider['image']; ?>" alt="<?php echo $slider['title']; ?>" class="img-thumbnail mb-2" style="max-width: 100%;">
                                    <?php else: ?>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="status" name="status" value="1" <?php echo $slider['status'] == 1 ? 'checked' : ''; ?>>
